...
def cropImageWithJsonLabel(dir, subcl=False):
    fls = os.listdir(dir)
    for f in fls:
        if f.find(".json") != -1:
...
if __name__ == '__main__':
    # dir =  "/Users/ZhouTang/Downloads/zzlab/1_Project/Wheat_rust_severity/source/modeling/experiment01_spillmancv/win_spillman_cv/f2"
